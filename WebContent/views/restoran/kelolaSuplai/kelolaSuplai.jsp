...
<%@page import="model.KelolaSuplai"%>
<%@page import="java.util.List"%>
<%@page import="dao.KelolaSuplaiDAOImpl"%>
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../menyuplai/suplai.jsp">
              <i class="icon-columns menu-icon"></i></i>
              <span class="menu-title">Data Suplai</span>
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="kelolaSuplai.jsp">
              <i class="icon-paper menu-icon"></i>
      ...
      <%
            	KelolaSuplaiDAOImpl kelolaSuplaiDAO = new KelolaSuplaiDAOImpl();
	            ...
	            <div class="col-md-12 grid-margin stretch-card">
	              <div class="card">
	                ...
	                <div class="row" style="margin-bottom: 20px;">
	                	<div class="col-md-11">
	                		<p class="card-title">Data Suplai</p>
	                	</div>
	                	<div class="col-md-1">
	                 ...
	                 <div class="row">
	                    <div class="col-12">
	                      <div class="table-responsive">
	                        <table id="tabelSuplai" class="display expandable-table" style="width:100%">
	                          <thead>
		                        <tr>
		                          <th>Id Bahan Baku</th>
		                          <th>Id Suplier</th>
                              <th>Id Staf Gudang</th>
                              <th>Tanggal</th>
                              <th>Jumlah</th>
		                          <th>Action</th>
		                      ...
		                      <tbody>
		                      <%
		                      	for (KelolaSuplai b : kelolaSuplaiDAO.getList()) {
		                      %>
								<pg:item>
		                        <tr>
		                          <td>Id Bahan Baku</td>
		                          <td>Id Suplier</td>
                              <td>Id Staf Gudang</td>
                              <td>Tanggal</td>
                              <td>Jumlah</td>
		                          <td>Action</td>
