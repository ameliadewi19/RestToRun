              ...
              <div class="card">
                ...
                <div class="row">
            	   <div class="col-6 grid-margin">
	                  ...
	                  <form class="form-sample" method="POST" action="/RestoranWeb/KeranjangServlet?command=konfirmasi">
                ...
                <div class="card-body">
					...
					%>
					  <div class="row">
	                    ...
	                    <div class="col-1">
	                		<a class="" href="/RestoranWeb/PesananServlet?command=batal&id_pelanggan=<%= id_plgn %>"><button type="button" class="btn btn-danger btn-rounded btn-icon">
