    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="diskon.jsp">
              <i class="icon-paper menu-icon"></i>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tabel Diskon</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                          ...
                          <th></th>
                          <th></th>
                          <th><a href="form_diskon.jsp"><button type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i></button></a></th>
                        </tr>
                        <tr>
                          <th>Id Menu</th>
                          <th>Tanggal Mulai</th>
