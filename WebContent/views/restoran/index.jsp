        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pemasok/pemasok.jsp">
              ...
              <span class="menu-title">Data Pemasok</span>
            </a>
          </li>
          <li class="nav-item">
        ...
        <div class="content-wrapper">
              ...
              <div class="row">
                ...
                <h3 class="font-weight-bold">Welcome 
		    	   ...
		    	   %> 
	                ...
	                %>
	                	<%=session.getAttribute("namaUser")%> 
	                <%
	                	}
	                %>
				</h3>
                  <h6 class="font-weight-normal mb-0">Welcome to RestToRun!</h6>
                </div>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin transparent" >
            	<div class="card">
            		<img alt="cafe" src="../../assets/restoran/images/dashboard/cafe.png" style="border-radius: 20px;">
            	</div>
            </div>
            <div class="col-md-6 grid-margin transparent">
              <div class="row">
