...
<%@page import="model.Menyuplai"%>
<%@page import="java.util.List"%>
<%@page import="dao.SuplaiDAOImpl"%>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="suplai.jsp">
	                    ...
	                    <div class="col-12">
	                      <div class="table-responsive">
	                        <table id="tabelSuplai" class="display expandable-table" style="width:100%">
		                      ...
		                      <tbody>
		                      <%
		                      		for (Menyuplai m : suplaiDAO.getList()) {
							            %>
								<pg:item>
		                        <tr>
		                          <td><%=m.getBahanbaku().getId_bahan()%></td>
		                          <td><%=m.getSuplier().getId_suplier()%></td>
