          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item active"> <a class="nav-link" href="stafGudang.jsp">Staf Gudang</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
	            ...
	            <div class="col-md-12 grid-margin stretch-card">
	              <div class="card">
	                ...
	                <div class="row" style="margin-bottom: 20px;">
	                	<div class="col-md-11">
	                		<p class="card-title">Data Staf Gudang</p>
	                	</div>
	                	<div class="col-md-1">
	                 ...
	                 <div class="row">
	                    <div class="col-12">
	                      <div class="table-responsive">
	                        <table id="tabelStafGudang" class="display expandable-table" style="width:100%">
	                          <thead>
		                        <tr>
