        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Data Bahan Baku</h4>
                  <form class="form-sample" method="POST" action="/RestoranWeb/BahanServlet?command=manajer_add">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <button class="btn btn-success mr-2">Tambah Bahan</button>
                      </div>
                    </div>
                  </form>
                </div>
