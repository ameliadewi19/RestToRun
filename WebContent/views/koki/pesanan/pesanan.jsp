	                    ...
	                    <div class="col-12">
	                      <div class="table-responsive">
	                        <table id="tabelPesan" class="display expandable-table" style="width:100%">
		                      ...
		                      <tbody>
		                      <%	for (PesananView p : pesananDAO.getListKhusus("koki")) {
								%>
								<pg:item>
		                        <tr>
		                          ...
		                          <td><a class="" style="margin-right: 30%" href="/RestoranWeb/ProsesPesananServlet?command=koki_mengelola&id_pesanan=<%= p.getId_pesanan() %>&email=<%= email %>"><i class="fa fa-cookie" ></i></a>
		                          		<a class="" href="/RestoranWeb/ProsesPesananServlet?command=koki_mengelola_selesai&id_pesanan=<%= p.getId_pesanan() %>&email=<%= email %>"><i class="fa fa-check"></i></a></td>
		                          </td>
