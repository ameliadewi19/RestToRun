	            ...
	            <div class="col-md-12 grid-margin stretch-card">
	              <div class="card">
	                ...
	                <div class="row" style="margin-bottom: 20px;">
	                	<div class="col-md-11">
	                		<p class="card-title">Data Pembayaran</p>
	                	</div>
	                	<div class="col-md-1">
	                 ...
	                 <div class="row">
	                    <div class="col-12">
	                      <div class="table-responsive">
	                        <table id="tabelPembayaran" class="display expandable-table" style="width:100%">
	                          <thead>
		                        <tr>
		                          <th>Id Pembayaran</th>
		                          <th>Id Pesanan</th>
							  ...
							  %>      
		                        ...
		                        <tr>
		                          ...
		                          <td><a class="" href="/RestoranWeb/ProsesPembayaranServlet?command=kasir_konfirmasi_pembayaran&id_pembayaran=<%= i.getId_invoice() %>"><i class="fa fa-check"></i></a></td>
