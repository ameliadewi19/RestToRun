                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="center"><input style="max-width: 80px;" type="number" name="num" class="form-control input-btn input-number" value="1"></td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table class="table table-clear">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="font-weight:bold"><strong>$7.477,36</strong><br></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="col-md-2 offset-md-10"><a class="btn btn-primary btn-shadow btn-lg" href="checkout.jsp" role="button">Order Now</a></div>
                                </div>
                            </div>
                        </div>
            </div>
