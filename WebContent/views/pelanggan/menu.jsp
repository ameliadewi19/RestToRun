	...
	<div class="container">
        ...
        <pg:item>
          <div class="col-lg-6 menu-item filter-starters">
            <img src="../../assets/pelanggan/img/menu/lobster-bisque.jpg" class="menu-img" alt="" style="margin-left: 1%">
            <div class="menu-content">
              <a href="detail_menu.jsp?id_menu=<%=m.getId_menu()%>"><%=m.getNama_menu()%></a><span><%=m.getHarga()%></span>
            </div>
            <div class="menu-ingredients">
              Jenis Menu: <%= m.getJenis_menu().getId_jenis() %>
            </div>
          </div>
        </pg:item>
        <%
