...
<section id="menu" class="menu section-bg">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="../../assets/pelanggan/img/menu/lobster-bisque.jpg" class="menu-img" alt="">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="../../assets/pelanggan/img/menu/bread-barrel.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="../../assets/pelanggan/img/menu/cake.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <img src="../../assets/pelanggan/img/menu/caesar.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="../../assets/pelanggan/img/menu/tuscan-grilled.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="../../assets/pelanggan/img/menu/mozzarella.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <img src="../../assets/pelanggan/img/menu/greek-salad.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <img src="../../assets/pelanggan/img/menu/spinach-salad.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="../../assets/pelanggan/img/menu/lobster-roll.jpg" class="menu-img" alt="">
            <div class="menu-content">
