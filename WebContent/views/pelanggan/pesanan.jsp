      ...
      <div class="row">
            ...
            <div class="col-lg-10">
                <div class="section-content bg-white p-5 shadow">
                    ...
                    <form method="POST" name="contact-us" action="/RestoranWeb/PelangganServlet?command=pelanggan_konfirmasi">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="name" name="nama_pelanggan" placeholder="Nama Pelanggan">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="number" class="form-control" id="phoneNumber" name="no_telp" placeholder="No Telepon">
                            </div>
                            <div class="col-md-12 form-group">
                                <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker4" placeholder="Date" name="tanggal">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">Tambah Data</button>
                            </div>
                        </div>
                    </form>
                </div>
