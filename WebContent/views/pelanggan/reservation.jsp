       ...
       <div class="row">
            ...
            <div class="col-lg-10">
                <div class="section-content bg-white p-5 shadow">
                    ...
                    <form method="POST" name="contact-us" action="/RestoranWeb/PelangganReservasiServlet?command=pelanggan_konfirmasi">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="name" name="nama" placeholder="Nama Pelanggan">
                            </div>
                            <div class="col-md-12 form-group">
                                <input type="number" class="form-control" id="phoneNumber" name="notelp" placeholder="No Telepon">
                            </div>
                            <div class="col-md-12 form-group">
