	                    ...
	                    <div class="col-12">
	                      <div class="table-responsive">
	                        <table id="tabelPesan" class="display expandable-table" style="width:100%">
		                      ...
		                      <tbody>
		                      <%	for (PesananView p : pesananDAO.getListKhusus("pelayan")) {
								%>
								<pg:item>
		                        <tr>
		                          ...
		                          <td><a class="" href="/RestoranWeb/ProsesPesananServlet?command=pelayan_mengantar_selesai&id_pesanan=<%= p.getId_pesanan() %>&email=<%= email %>"><i class="fa fa-check" ></i></a></td>
